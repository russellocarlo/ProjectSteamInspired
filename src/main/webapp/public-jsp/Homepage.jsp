...
<body>	
		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="navbarSupportedContent">
		      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		        <li class="nav-item">
		          <a class="nav-link active" aria-current="page" href="<%=request.getContextPath()%>/ServletPerPaginaLogin">Login</a>
		        </li>
		        <li class="nav-item">
	...
	<div class="container justify-content-center" id="cont-fluido"">
		...
		<form action="ServletPerHomePage">
			<select name='generePerFiltrare'>
								     ...
								     <div class="card-body" id="corpo-carte">
								       <h5 class="card-title"> <strong><%= g.getNome()%> </strong></h5>
								        ...
								        <%if(g.getOfferta()!= null){%>
									       <div class="row">
										       	<div class="col-md-3">
									       			<p style="color: #FF640A"><em><del><%=g.getPrezzo() %> €</del></em></p>
									       		</div>
