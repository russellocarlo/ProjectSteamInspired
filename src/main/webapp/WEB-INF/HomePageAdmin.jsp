...
<body>	
		      ...
		      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		       	 	...
		       	 	<li class="nav-item">
				          <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
				            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Steam_icon_logo.svg/1200px-Steam_icon_logo.svg.png" alt="logo steam navbar"  style="max-width: 5vh; max-height:5vh; margin-top:-1.5vh;">
				          </a>
		        	</li>
	...
	<div class="container" id="cont-fluido">
		<div class='row'>
	    <% 
								    ...
								    <div class="card" style="max-widht: 50vh;">
								     ...
								     <div class="card-body" id="corpo-carte">
							      	 ...
							      	 <div class= "row" style="margin-top: 5vh;">
										     ...
										     <%if(utente.getRuolo() == Ruolo.ADMIN || g.getUtente().getId() == utente.getId()){ %> 
...
<script src="<%=request.getContextPath()%>/js/HomepageAdminJS.js"></script>
